document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('focusout', function(e) {
            ...
            if (!input || !contactForm.contains(input)) return;
            validateField(input);
        });
    ...
    if (animatedElements.length > 0) {
        ...
        animatedElements.forEach(function(element) {
            ...
            if (!element.classList.contains('visible') && !element.classList.contains('fade-in-visible')) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '90480248-4af9-4d90-acaf-0f59fdbe956e',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '90480248-4af9-4d90-acaf-0f59fdbe956e';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '90480248-4af9-4d90-acaf-0f59fdbe956e';
